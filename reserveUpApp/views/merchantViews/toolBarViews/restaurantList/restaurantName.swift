...
struct restaurantName: View {
    ...
    @State var restaurantNameConfirmed : String = "Pizza Restaurant"
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 8, content: {
            ...
            TextField("Test Name", text:$restaurantName,
        ...
        VStack(alignment: .leading, spacing: 8, content: {
            ...
            TextField("Test Name", text:$restaurantNameConfirmed,
                      onEditingChanged: { (isBegin) in
                if isBegin {
        ...
        .padding()
            ...
            Button(action: {
                if restaurantNameConfirmed != restaurantName{
...
struct restaurantName_Previews: PreviewProvider {
